...
export default function Auth() {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      setFormError((err as Error).message || "Failed to start Google sign in");
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleAuth} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                className="bg-input text-foreground border border-border focus:ring-2 focus:ring-primary/60 focus:border-primary/80"
                data-testid={
                  isRegistering ? "register-password" : "login-password"
                }
              />
            </div>
            <Button
              ...
              <span className="flex items-center">
                <svg className="w-5 h-5 mr-2" viewBox="0 0 48 48">
                  <g>
                    <path
                      fill="#fbc02d"
                      d="M43.6 20.5h-1.6V20H24v8h11.3c-1.6 4.3-5.7 7-11.3 7-6.6 0-12-5.4-12-12s5.4-12 12-12c2.7 0 5.2.9 7.2 2.4l6-6C34.5 5.1 29.5 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 19.5-7.6 21-18h-1.4z"
                    />
                    <path
                      fill="#e53935"
                      d="M6.3 14.7l6.6 4.8C14.5 16.1 18.9 13 24 13c2.7 0 5.2.9 7.2 2.4l6-6C34.5 5.1 29.5 3 24 3c-7.2 0-13.4 3.1-17.7 8z"
                    />
                    <path
                      fill="#4caf50"
                      d="M24 45c5.4 0 10.4-1.8 14.3-4.9l-6.6-5.4C29.1 36.9 26.7 37.7 24 37.7c-5.6 0-10.3-3.8-12-9H6.3C8.6 39.2 15.7 45 24 45z"
                    />
                    <path
                      fill="#1565c0"
                      d="M43.6 20.5h-1.6V20H24v8h11.3c-1.1 3-3.7 5.2-7.3 5.2-2.1 0-4-.7-5.5-1.9l-6.6 5.4C14.5 43.9 19.5 45 24 45c10.5 0 19.5-7.6 21-18h-1.4z"
                    />
                  </g>
                </svg>
