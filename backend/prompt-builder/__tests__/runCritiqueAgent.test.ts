import { PromptInput, IntentMode, Stage, SimpPreference } from '../types';

const mockBuildSystemPrompt = jest.fn(() => 'SYSTEM_PROMPT');
const mockBuildUserPrompt = jest.fn(() => 'USER_PROMPT');

jest.mock('../buildSystemPrompt', () => ({ buildSystemPrompt: mockBuildSystemPrompt }));
jest.mock('../buildUserPrompt', () => ({ buildUserPrompt: mockBuildUserPrompt }));
